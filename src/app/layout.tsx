...
export const metadata: Metadata = {
  ...
  title: {
    default: `تعمیر تلویزیون دوو و اسنوا در تهران | ${siteConfig.legalName}`,
  ...
  keywords: [
    ...
    'تعمیرات تلویزیون',
    'تعمیر برد تلویزیون دوو',
    'تعمیر برد تلویزیون اسنوا',
    'فلش اندروید تلویزیون اسنوا',
    'تعویض بک لایت تلویزیون دوو',
    'تعمیر برد تلویزیون',
  ...
  openGraph: {
    ...
    title: `تعمیر تلویزیون دوو و اسنوا در تهران | ${siteConfig.legalName}`,
    description: siteConfig.description,
  },
