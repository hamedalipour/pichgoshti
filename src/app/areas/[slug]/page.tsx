...
const areaFaqs = [
  ...
  { q: 'کدام خرابی‌ها در محل تعمیر می‌شوند؟', a: 'تعمیر برد پاور، مشکلات آنتن و گیرنده، نصب و جابه‌جایی و تعویض بک‌لایت با تجهیزات سیار در محل شما انجام می‌شود. فقط تعویض پنل به دلیل حساسیت بالا به کارگاه منتقل می‌شود.' },
