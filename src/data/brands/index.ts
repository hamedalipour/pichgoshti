...
export function getBrandFaqs(brand: Brand): { q: string; a: string }[] {
  ...
  return [
    ...
    },
    {
      ...
      a: `بله؛ عیب‌یابی، تعمیر برد پاور و تعویض بک‌لایت ${brand.name} با تجهیزات سیار در خانه شما انجام می‌شود و تلویزیون جابه‌جا نمی‌شود. فقط تعویض پنل به دلیل حساسیت بالا با بسته‌بندی ایمن به کارگاه منتقل و پس از تعمیر همان‌جا نصب می‌شود.`,
    },
    {
